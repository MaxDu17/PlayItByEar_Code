...
class BlockedTableArena(Arena):
    """
    Workspace that contains an empty table and a wall.
    ...
    def __init__(
        ...
        has_legs=True,
        xml="arenas/blocked_table.xml", #change back to blocked_table.xml, or for higher table use blocked_table_higher.xml
    ):
