...
#         print("######  ", index)
        ...
        lowdim, obses, audio, actions, rewards, next_lowdim, next_obses, next_audio, not_dones_no_max = self.allEpisodes[index].sample_rollout(self.length, self.shaped_rewards, correctionsOnly = self.correctionsOnly)
        
#         print("audio ablations!")
#         audio = np.zeros_like(audio)
#         next_audio = np.zeros_like(next_audio)
#         print("video ablations!")
